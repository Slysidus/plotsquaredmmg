...
public class RegionFile {
    ...
    public synchronized DataInputStream getChunkDataInputStreamFromRawChunk(int chunkX, int chunkZ) {
        return getChunkDataInputStream(Math.floorMod(chunkX, 32), Math.floorMod(chunkZ, 32));
    }
    ...
    public DataOutputStream getChunkDataOutputStreamFromRawChunk(int chunkX, int chunkZ) {
        return getChunkDataOutputStream(Math.floorMod(chunkX, 32), Math.floorMod(chunkZ, 32));
    }
